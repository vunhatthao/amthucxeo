...
<div class="row">
	<ol class="breadcrumb">
		...
		<li>
			<i class="fa fa-clock-o"></i> Cấu hình thời gian
		</li>
	</ol>
</div>
<!-- /.row -->
...
if(isset($_POST['update'])) {
	...
	loadPageSucces("Đã cập nhật thông tin cấu hình thành công.","?".TTH_PATH."=config_datetime");
}
?>
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="table-respon">
					<form action="?<?php echo TTH_PATH?>=config_datetime" method="post">
