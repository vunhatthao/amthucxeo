...
<div class="row">
	<ol class="breadcrumb">
		...
		<li>
			<a href="?<?php echo TTH_PATH?>=street_manager"><i class="fa fa-edit"></i> Quản lý nội dung</a>
		</li>
		<li>
			<a href="?<?php echo TTH_PATH?>=street_manager"><i class="fa fa-street-view"></i> Dữ liệu đường phố</a>
		</li>
		<li>
