...
//
function articleMenu($act, $typeFunc, $article_menu_id, $category_id, $name, $slug, $title, $description, $keywords, $parent, $comment, $font_icon, $plus, $is_active, $hot, $img, $error) {
	global $tth, $db;
				...
				<form action="<?php echo $act?>" method="post" enctype="multipart/form-data">
					...
					<table class="table table-hover" style="width: 70%;">
						...
						<tr>
							...
							<td><textarea class="form-control" name="plus" rows="3"><?php echo stripslashes($plus)?></textarea></td>
						</tr>
						<tr>
							<td align="right" class="ver-top"><label>Mô tả:</label></td>
							<td><textarea class="form-control" id="comment" name="comment" rows="3"><?php echo stripslashes($comment)?></textarea></td>
						</tr>
						<tr>
