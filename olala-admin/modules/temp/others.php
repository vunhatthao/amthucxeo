			...
			<div class="panel-body">
				<form action="<?php echo $act?>" method="post" enctype="multipart/form-data">
					...
					<table class="table table-hover" style="width: 70%;">
						...
						<tr>
							<td align="right"><label>Từ:</label></td>
							<td><input class="form-control" type="text" name="p_from" maxlength="250" value="<?php echo stripslashes($p_from)?>"></td>
						</tr>
						<tr>
							<td align="right"><label>Đến:</label></td>
							<td><input class="form-control" type="text" name="p_to" maxlength="250" value="<?php echo stripslashes($p_to)?>"></td>
						</tr>
						<?php } ?>
						<tr>
