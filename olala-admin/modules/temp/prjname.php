		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $act?>" method="post" enctype="multipart/form-data">
					...
					<input type="hidden" name="prjname_id" value="<?php echo $prjname_id?>" />
					...
					<table class="table table-hover" style="width: 70%;">
						...
						<tr>
							<td colspan="2" align="center">
								...
								<button type="button" class="btn btn-form-info btn-form" onclick="location.href='?<?php echo TTH_PATH?>=prjname_manager'">Thoát</button>
							</td>
						</tr>
					</table>
				</form>
