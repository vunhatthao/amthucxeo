...
//
function article($act, $typeFunc, $article_id, $article_menu_id, $name, $slug, $title, $description, $keywords, $img, $img_note, $comment, $content, $is_active, $hot, $created_time, $upload_img_id, $error) {
	global $db, $tth;
	$category = 0;
			...
			<div class="panel-body">
				<form action="<?php echo $act?>" method="post" enctype="multipart/form-data">
					...
					<table class="table table-hover">
						...
						<tr>
							<td align="right"><label>Nội dung chi tiết:</label></td>
							<td colspan="3">&nbsp;</td>
						</tr>
						<tr>
							<td colspan="4"><textarea class="form-control" name="content" id="content" required="required" ><?php echo stripslashes($content)?></textarea></td>
						</tr>
						<tr>
