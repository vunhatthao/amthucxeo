			...
			<div class="panel-body">
				<div class="table-respon">
					<form action="<?php echo $act?>" method="post" enctype="multipart/form-data">
						...
						<input type="hidden" name="tour_menu_id" value="<?php echo $tour_menu_id?>" />
						...
						<table class="table table-hover" style="width: 70%;">
							...
							<tr>
								<td colspan="2" align="center">
									...
									<button type="button" class="btn btn-form-info btn-form" onclick="location.href='?<?php echo TTH_PATH?>=tour_manager'">Thoát</button>
								</td>
							</tr>
						</table>
					</form>
...
<script>
	$('.file-img').fileinput({
		<?php if($img!='no' && $img!='') { ?>
		initialPreview: [
			"<img src='../uploads/tour_menu/<?php echo $img?>' class='file-preview-image' title='<?php echo $img?>' alt='<?php echo $img?>'>"
		],
		<?php } ?>
