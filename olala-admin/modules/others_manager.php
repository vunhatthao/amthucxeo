				...
				<table class="table table-manager table-hover">
					...
					foreach($rows as $row) {
						...
						<tr class="category">
							...
							?>
							<td align="center">
								<a href="?<?php echo TTH_PATH?>=others_menu_add&id_cat=<?php echo $row["category_id"]?>"><img data-toggle="tooltip" data-placement="left" title="Thêm mục" src="images/add.png"></a>
								&nbsp;
	...
	foreach($rows2 as $row) {
		...
		<tr>
			...
			<td align="center">
				...
				if ($level <= 30){
					?>
					<a href="?<?php echo TTH_PATH?>=others_menu_add&id_cat=<?php echo $row["category_id"]?>&id_art=<?php echo $row["others_menu_id"]?>"><img data-toggle="tooltip" data-placement="left" title="Thêm mục" src="images/add.png"></a>
					&nbsp;
				<?php } else { ?>
					<span style="width: 16px; height: 1px; display: inline-block;""></span>
					&nbsp;
				<?php } ?>
				<a href="?<?php echo TTH_PATH?>=others_menu_edit&id=<?php echo $row["others_menu_id"]?>"><img data-toggle="tooltip" data-placement="top" title="Chỉnh sửa" src="images/edit.png"></a>
				&nbsp;
				<?php
				...
				<?php
					...
					?>
					<a class="confirmManager" style="cursor: pointer;" id="?<?php echo TTH_PATH?>=others_manager&del=<?php echo $row["others_menu_id"]?>"><img data-toggle="tooltip" data-placement="right" title="Xóa mục" src="images/remove.png"></a>
				<?php }
				//----------- end if ------------
				?>
			</td>
			<td align="center">
				<a href="?<?php echo TTH_PATH?>=others_list&id=<?php echo $row['others_menu_id']?>"><img data-toggle="tooltip" data-placement="top" title="Danh sách trường" src="images/list.png"></a>
			</td>
			<?php
			if ($level <= 30){
