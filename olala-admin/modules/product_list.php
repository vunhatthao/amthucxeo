...
<!-- /.row -->
<?php echo dashboardCoreAdminTwo("product_list;".$category_id_core)?>
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default panel-no-border">
			<div class="table-responsive">
				<form action="?<?php echo TTH_PATH?>=product_list" method="post" enctype="multipart/form-data" id="deleteArt">
					<input type="hidden" name="list_id" value="<?php echo $product_menu_id?>" />
					<table class="table display table-manager" cellspacing="0" cellpadding="0" id="dataTablesList">
						...
						foreach($rows as $row) {
							...
							<tr>
								...
								<td><?php echo formatNumberVN($row['price'])?></td>
								<?php
								//-----------Kiểm tra phân quyền ---------------------------------------
