...
<div class="row">
	<ol class="breadcrumb">
		...
		<li>
			<a href="?<?php echo TTH_PATH?>=prjname_manager"><i class="fa fa-edit"></i> Quản lý nội dung</a>
		</li>
		<li>
			<a href="?<?php echo TTH_PATH?>=prjname_manager"><i class="fa fa-tag"></i> Dữ liệu tên dự án</a>
		</li>
		<li>
