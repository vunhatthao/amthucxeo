		...
		if($OK) {
			...
			if($handleUploadImg) {
				...
				if($category_id==13) {
					...
					$imgUp->file_new_name_body    = 'part-' . $name_image;
					$imgUp->image_resize          = true;
					$imgUp->image_ratio_crop      = true;
					$imgUp->image_x               = 480;
					$imgUp->image_y               = 480;
				...
				$imgUp->file_new_name_body    = 'img-' . $name_image;
				$imgUp->image_resize          = true;
				$imgUp->image_ratio_crop      = true;
				$imgUp->image_x               = 452;
				$imgUp->image_y               = 315;
...
if(!$OK) gallery("?".TTH_PATH."=gallery_edit", "edit", $gallery_id, $gallery_menu_id, $name, $slug, $img, $comment, $content, $link, $is_active, $hot, $created_time, $upload_img_id, $error);