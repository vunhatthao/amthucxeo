...
<div class="row">
	<ol class="breadcrumb">
		...
		<li>
			<a href="?<?php echo TTH_PATH?>=plugin_page"><i class="fa fa-edit"></i> Quản lý nội dung</a>
		</li>
		<li>
			<a href="?<?php echo TTH_PATH?>=plugin_page"><i class="fa fa-file-text-o"></i> Phần trang bổ sung</a>
		</li>
		<li>
