	...
	<div class="col-lg-12">
		<div class="panel panel-default panel-no-border">
			<div class="table-responsive">
				<form action="?<?php echo TTH_PATH?>=order_list" method="post" enctype="multipart/form-data" id="delete">
						...
						foreach($rows as $row) {
							...
							<tr>
								...
								<td class="details-control" align="center">
									<span class="btn btn-primary btn-sm-sm" data-toggle="modal" data-target="#_order" onclick="return open_modal_order(<?php echo $row['order_id']?>);">Xem</span>&nbsp;
									<div class="checkbox">
										<label class="checkbox-inline">
											<input type="checkbox" data-toggle="tooltip" data-placement="top" title="Xóa" class="checkbox" name="idDel[]" value="<?php echo $row['order_id']?>">
										</label>
									</div>
								</td>
							</tr>
					...
					<!-- /.modal -->
					<div class="row">
						<div class="col-sm-6"><?php echo showPageNavigation($page, $totalpages,'?'.TTH_PATH.'=order_list&page=')?></div>
