...
<div class="row">
	<ol class="breadcrumb">
		...
		<li>
			<a href="?<?php echo TTH_PATH?>=car_manager"><i class="fa fa-edit"></i> Quản lý nội dung</a>
		</li>
		<li>
			<a href="?<?php echo TTH_PATH?>=car_manager"><i class="fa fa-car"></i> Thuê xe</a>
		</li>
		<li>
			<i class="fa fa-list"></i> <?php echo getNameMenu($car_menu_id, 'car')?>
		</li>
		<a class="btn-add-new" href="?<?php echo TTH_PATH?>=car_add&id=<?php echo $car_menu_id?>">Thêm xe</a>
	</ol>
</div>
<!-- /.row -->
<?php echo dashboardCoreAdminTwo("car_list;".$category_id_core)?>
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default panel-no-border">
			<div class="table-responsive">
				<form action="?<?php echo TTH_PATH?>=car_list" method="post" id="deleteArt">
					<input type="hidden" name="list_id" value="<?php echo $car_menu_id?>" />
								...
								<td class="details-control" align="center">
									<div class="checkbox">
										...
										<label class="checkbox-inline">
											<input type="checkbox" data-toggle="tooltip" data-placement="top" title="Xóa" class="checkboxArt" name="idDel[]" value="<?php echo $row['car_id']?>">
										</label>
									</div>
								</td>
							</tr>
					...
					<div class="row">
						<div class="col-sm-6"><?php echo showPageNavigation($page, $totalpages,'?'.TTH_PATH.'=car_list&id='.$car_menu_id.'&page=')?></div>
						<div class="col-sm-6" align="right" style="padding: 7px 0;">
							...
							<input type="button" class="btn btn-primary btn-xs <?php echo in_array("car_del;".$category_id_core,$corePrivilegeSlug)? "confirmManager" : "alertManager"?> " value="Xóa" name="deleteArt">
						</div>
					</div>
				</form>
			</div>
