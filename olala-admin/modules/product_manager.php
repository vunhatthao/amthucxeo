...
function loadMenuCategory($db, $level, $parent, $category_id){
	...
	foreach($rows2 as $row) {
	    ...
	    <tr>
	        <td>&nbsp;</td>
	        <td style="padding: 0 0 0 <?php echo $level?>px;"><img src="images/node.png" /> <?php echo stripslashes($row['name'])?><span class="bold-red">(<?php echo countProductZe($row["product_menu_id"]);?>)</span></td>
			<?php
			//-----------Kiểm tra phân quyền ---------------------------------------
	        ...
	        <td align="center"><a href="?<?php echo TTH_PATH?>=product_list&id=<?php echo $row['product_menu_id']?>"><img data-toggle="tooltip" data-placement="top" title="Danh sách bài viết" src="images/list.png"></a></td>
	        <?php
			if ($level < 30){
