...
<div class="row">
	<ol class="breadcrumb">
		...
		<li>
			<a href="?<?php echo TTH_PATH?>=core_role"><i class="fa fa-dashboard"></i> Quản trị hệ thống</a>
		</li>
		<li>
			<a href="?<?php echo TTH_PATH?>=core_role"><i class="fa fa-group"></i> Nhóm quản trị</a>
		</li>
		<li>
			<i class="fa fa-list"></i> <?php echo $name?>
		</li>
	</ol>
</div>
<!-- /.row -->
