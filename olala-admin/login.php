...
<head>
	...
	<meta name="description" content="Administration Control Panel - Olala Web | Olala Group">
	<meta name="author" content="Olala Web | Olala Group (info@olalaweb.vn)">

	<title>Administration Control Panel - Olala Web | Olala Group</title>
	<!-- Custom CSS -->
...
<div class="container">
    ...
    <section class="main">
		<a target="_blank" href="http://olala-team.com">
			<div class="logo"></div>
		</a>
